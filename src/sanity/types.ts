...
export type Cta = {
	_type: 'cta'
	link?: Link
	style?: 'action' | 'action-accent' | 'action-outline' | 'ghost' | 'link'
}
...
export type SITE_QUERY_RESULT = {
	...
	ctas: Array<{
		...
		link:
			...
			| null
		style?: 'action-accent' | 'action-outline' | 'action' | 'ghost' | 'link'
	}> | null
	footer: {
		items: Array<
			| {
